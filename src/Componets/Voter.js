...
import GenderPieChart from './New';
...
function Voter() {
  ...
  const columns = [
    { title: 'Constituency', dataIndex: 'Constituency_name', key: 'Constituency_name' },
    ...
    { title: 'Residential_Status', dataIndex: 'Residential_Status', key: 'Residential_Status' },
    {
      ...
      key: 'actions',
      render: (text, record) => (
        <button onClick={() => handleUpdate(record)} className="btn btn-outline-success">Post</button>
      ),
    },
  ...
  return (
    <>
      ...
      <div className="row mt-3 px-1" style={{marginLeft:"0.3rem"}}>
        <div className="col-md-6">
          ...
          <select
            ...
            onChange={(event) => handleFilterChange('Sachivalayam_name', event.target.value)}
          >
        ...
        <div className="col-md-6">
          ...
          <select
            ...
            onChange={(event) => handleFilterChange('Part_No', event.target.value)}
          >
      ...
      >
        ...
        {/* Add any additional content or actions for the modal */}
      </Modal>
    </>
  );
}
