    ...
    <>
      <div className='container-fluid ml-3'>
        <div className='row '>
          ...
          <div className="shadow-lg p-3 col-md-3  bg-white rounded h-55" style={{marginLeft:"1rem",marginTop:"3rem" ,width:"28rem"}}>
            <div className="row mt-5">
                ...
                <div className='col-md-3 font-weight-bold mb- ml-3 '>
                    <a className='font-weight-bold text-decoration-underline color' id="text-custom-colot-clear-all">Clear All</a>
                </div>
            </div>
            <div className='row'>
        ...
        <div className="col-md-6">
          ...
          >
            {getDropdownOptions(voters, 'Part_No').map((option, index) => (
              ...
              //       .includes(input.toLowerCase()))
              // }
              // optionFilterProp="label" // Set the optionFilterProp to "label"
            >
            ...
            <div className="col-md-5">
              <label className="fs-5 px-0" style={{}}>Age Range:</label>
...
// import 'bootstrap/dist/css/bootstrap.min.css';
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import { faDashboard, faFilter } from '@fortawesome/free-solid-svg-icons';
// import axios from 'axios';
...
//         (filters.Part_No === '' || voter.Part_No.includes(filters.Part_No)) &&
//         // (filters.volunteer === '' || voter.volunteer.includes(filters.volunteer)) &&
//         // (filters.issue === '' || voter.issue.includes(filters.issue)) &&
//         // (voter.ticketid !== null) &&
//         ageInRange &&
//         (filters.gender === '' || voter.Gender.trim() === filters.gender.trim())
//       );
...
// //   const getDropdownOptions = (data, key, prevFilters) => {
// //     let filteredData = data;

// //     // Filter data based on previous selections
// //     for (const [prevKey, prevValue] of Object.entries(prevFilters)) {
// //       if (prevValue !== '') {
...
//     { title: 'Issue', dataIndex: 'issue', key: 'issue' },
//     { title: 'Status', dataIndex: 'status', key: 'status' },
//     // Add your columns here based on your data structure
//     // Example: { title: 'Ticket ID', dataIndex: 'ticketid', key: 'ticketid' },
//     // Add similar columns for other fields
//   ];

//   const dataSource = filteredVoters.map((data, index) => ({
//     // Map your data fields here
//     // Example: ticketid: data.ticketid,
//     // Map similar fields for other columns
...
//             </div>
//             <div></div>
//             <Table className='overflow-auto h-95'
//               dataSource={filteredVoters}
//               columns={columns}
//               bordered
//               rowSelection={{
...
//           <div className="shadow-lg p-3 col-md-3  bg-white rounded h-55" style={{marginLeft:"1rem",marginTop:"7rem" ,width:"28rem"}}>
//             <div className="row mt-5">
//                 <div className='col-md-6 col-sm-7 font-weight-bold mb-3'>
//                     <FontAwesomeIcon id="filter-icon" icon={faFilter} /><label id="ticket-list-filterby font-weight-bold">Filter by</label>
//                 </div>
...
//                     <label className='font-weight-bold' id="filterbox-Volunteer">Part_Serial_No:</label>
//               <Select
//               showSearch
//               className="form-select p-0 col-md-12 bg-white rounded"
//               placeholder="Select Part_Serial_No"
...
//                         </div>
//                         <div className="col-md-10">
//                             <h5 className="filterbox-chandragiri p-2 font-weight-bold font-size-small mt-2 border " id="filterbox-totaltickets-count" style={{ background: 'linear-gradient(90deg, #113857 80%, #808080 20%)', color: 'white', borderRadius: '10px' }}>Total Voters&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{totalVoterCount}</h5>
//                             <label></label>
//                         </div>
//                         <div className="col-md-6">                
//                         </div>
